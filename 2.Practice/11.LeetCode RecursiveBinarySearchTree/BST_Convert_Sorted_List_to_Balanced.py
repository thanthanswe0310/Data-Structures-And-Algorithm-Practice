...
# Recursively build the left subtree using left, mid-1.
# Recursively build the right subtree using mid+1, right.
...
class BinarySearchTree:
    ...
    # Public method to convert a sorted list to a BST
    def sorted_list_to_bst(self, nums):
        self.root = self.__sorted_list_to_bst(nums, 0, len(nums) - 1)

    # Private helper method to build a height-balanced BST
